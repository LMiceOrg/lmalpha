...
#define lmice_bson_t bson_t
forceinline lmice_bson_t* eal_bson_append_array(lmice_bson_t* doc, const char* key, lmice_bson_t* obj)
{
    bson_append_array(doc, key, -1, obj);
    return doc;
}
